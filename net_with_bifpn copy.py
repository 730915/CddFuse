...
class BiFPNDecoder(nn.Module):
    ...
    def forward(self, inp_img, base_feature, detail_feature):
        ...
        p4_in = F.interpolate(p3_in, scale_factor=0.5, mode='nearest')  # 1/2尺寸
        p5_in = F.interpolate(p4_in, scale_factor=0.5, mode='nearest')  # 1/4尺寸
        p6_in = F.interpolate(p5_in, scale_factor=0.5, mode='nearest')  # 1/8尺寸
        p7_in = F.interpolate(p6_in, scale_factor=0.5, mode='nearest')  # 1/16尺寸
