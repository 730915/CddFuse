'''
使用IRCSA模块替换Restormer（transformer block）中的MDTA的测试代码
'''
import sys
import os
# 使用绝对路径来确保正确添加项目根目录
...
from net_IRCSA import Restormer_Decoder,Restormer_Encoder, BaseFeatureExtraction, DetailFeatureExtraction
import os
import numpy as np
...
ckpt_path=r"models/CDDFuse_IRCSA_04-09-21-59.pth"
